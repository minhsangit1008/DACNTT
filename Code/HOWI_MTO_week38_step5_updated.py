...
# Thiết lập logging
logging.basicConfig(level=logging.INFO, filename='howi_mto_week38_step5.log', filemode='w',
...
def tune_parameters(transactions_file, weights_file):
    ...
    min_wio_values = [0.15]  # Tinh chỉnh để đạt 50-60 tập mục
    min_ws_values = [0.15]
    ...
    results_df.to_csv('result_week38_step5.csv', index=False)
    logging.info("Results saved to result_week38_step5.csv")
    print("\nResults saved to result_week38_step5.csv")
