...
# Thiết lập logging
logging.basicConfig(level=logging.INFO, filename='howi_mto_week38_optimized.log', filemode='w',
...
def tune_parameters(transactions_file, weights_file):
    ...
    results_df.to_csv('result_week38_step1_optimized.csv', index=False)
    logging.info("Results saved to result_week38_step1_optimized.csv")
    print("\nResults saved to result_week38_step1_optimized.csv")
